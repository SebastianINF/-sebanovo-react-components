import { _ as ea, m as pl, a as ta } from "./WithTooltip-V3YHNWJZ--jWFzE_X.js";
var cl = ta({ "node_modules/prettier/parser-html.js"(Jr, Xr) {
  (function(Ae) {
    ...
    var Ae = (ot, Ne) => () => (Ne || ot((Ne = { exports: {} }).exports, Ne), Ne.exports), Yt = Ae((ot, Ne) => {
      ...
      Ne.exports = Se(typeof globalThis == "object" && globalThis) || Se(typeof window == "object" && window) || Se(typeof self == "object" && self) || Se(typeof global == "object" && global) || /* @__PURE__ */ function() {
        return this;
      ...
      var Se = wi(), Oe = dr(), ee = Br(), V = $r(), W = V("toStringTag"), Z = Object, Y = ee(/* @__PURE__ */ function() {
        return arguments;
...
`) {
  ...
  (function(Ae) {
    ...
    var Ae = (ee, V) => () => (V || ee((V = { exports: {} }).exports, V), V.exports), Yt = Ae((ee, V) => {
      ...
      V.exports = W(typeof globalThis == "object" && globalThis) || W(typeof window == "object" && window) || W(typeof self == "object" && self) || W(typeof global == "object" && global) || /* @__PURE__ */ function() {
        return this;
      }() || Function("return this")();
    }), hr = Ae((ee, V) => {
      ...
      var W = Au(), Z = dr(), Y = Br(), ne = $r(), Fe = ne("toStringTag"), je = Object, he = Y(/* @__PURE__ */ function() {
        return arguments;
...
`) : C(X);
        ...
        function be(X, se, we) {
          return J(X) ? (se = c(se), typeof se == "string" && a(se) < we.tabWidth + 3) : !1;
        }
        function fe(X, se) {
          let we = Ie(X);
          if (t(we)) {
