import { R as n, r as i } from "./index-_zimet0g.js";
import { u as m, r as d } from "./react-18-JZek_8Ip.js";
const { global: u } = __STORYBOOK_MODULE_GLOBAL__;
var { FRAMEWORK_OPTIONS: s } = u, w = (r, e) => {
  let { id: o, component: t } = e;
  if (!t)
    throw new Error(`Unable to render story ${o} as the component annotation is missing from the default export`);
